...
CFLAGS = -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Waggressive-loop-optimizations -Wc++14-compat -Wmissing-declarations \
         ...
         -flto-odr-type-merging -fno-omit-frame-pointer -Wlarger-than=8256 -Wstack-usage=8192 -pie -fPIE -Werror=vla \
...
SOURCES = src/main.cpp src/logger.cpp src/stack.cpp src/debug.cpp
